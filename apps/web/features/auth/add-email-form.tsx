...
export function AddEmailForm({ labels }: { labels: { emailLabel: string; passwordLabel: string; submit: string; success: string } }) {
  ...
  async function onSubmit(event: React.FormEvent) {
    ...
    const res = await fetch(`${apiUrl}/api/v1/me/email`, {
      method: 'POST',
